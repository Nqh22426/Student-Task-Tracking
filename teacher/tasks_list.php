...
<!-- Add inline styles for the tasks list -->
<style>
/* Tasks List Styling */
.main-content {
    margin-left: 180px; /* Reduced from 200px to match new sidebar width */
    padding: 20px;
            ...
            <div class="tasks-container">
                ...
                <?php else: ?>
                    <?php foreach ($tasks as $task): 
                        ...
                        // For debugging - uncomment to check time comparison
                        ...
                        //echo "<!-- Is now < start? " . ($now < $start_date ? "Yes" : "No") . " -->";
                        //echo "<!-- Is now > end? " . ($now > $end_date ? "Yes" : "No") . " -->";
