...
<head>
    ...
    <!-- Override styles here to fix navbar overlap -->
    <style>
        .main-content {
            margin-left: 180px;
            padding: 20px;
        ...
        /* This wrapper properly positions the content below the navbar */
        .students-wrapper {
            position: relative;
            top: 60px; /* This pushes content down below navbar */
            margin-bottom: 80px; /* Add some bottom margin to ensure everything is visible */
        }
