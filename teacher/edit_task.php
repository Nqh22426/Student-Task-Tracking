...
// First, get the task details and ensure it belongs to a class owned by the current teacher
try {
    $stmt = $pdo->prepare(
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (typeof flatpickr !== 'undefined') {
        ...
        const endPicker = flatpickr("#taskEndDatetime", {
            ...
            onOpen: function() {
                // Ensure the minDate constraint is properly applied when opening
