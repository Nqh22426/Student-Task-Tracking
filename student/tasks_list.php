...
// Đặt múi giờ giống với To-do List
...
<head>
    ...
    <script>
        // Force clean any lingering modal backdrops on page load
    ...
    /* Tasks List Styling */
    .main-content {
        margin-left: 180px; /* Match teacher page */
        padding: 20px;
        padding-top: 68px; /* Match teacher page for consistent positioning */
    }
    ...
    .tasks-container {
        ...
        padding: 20px; /* Match teacher page */
        margin-bottom: 30px;
        margin-top: 45px; /* This gives space below the navbar */
    }

    /* Alert styling and positioning */
    .alert {
        margin-top: 45px; /* Position the alert at the same starting point as tasks-container */
    ...
    .alert + .alert + .tasks-container {
        margin-top: 10px; /* Reduced top margin when alerts are present */
    }
    ...
    .tasks-header {
        ...
        align-items: center;
        margin-bottom: 20px; /* Match teacher page */
    }
    ...
    .task-list-item {
        ...
        padding: 15px;
        margin-bottom: 15px;
        transition: box-shadow 0.2s, transform 0.2s; /* Match teacher page */
    }
    ...
    /* Task status styling like teacher page */
    ...
    /* Days remaining styling - make it match Todo List exactly */
    .days-left {
        display: none !important; /* Hide days left completely */
    }
    
    /* Hide any other related elements */
    .days-left.urgent {
    ...
    /* Adjust the tasks list layout to ensure proper alignment */
    ...
    /* Ensure consistent spacing for tasks with and without PDF files */
    .col-md-8 {
        padding-bottom: 10px;
    }

    /* Submitted file styling */
    ...
    .submission-content {
        padding: 10px;
        position: relative;
        padding-bottom: 40px; /* Space for unsubmit button */
    }
    ...
    .submission-content .file-btn {
        ...
        white-space: nowrap;
        padding: 6px 12px;
        font-size: 0.875rem; /* Increased from 0.75rem to match To-do List */
        line-height: 1.5; /* Added line-height to match To-do List */
        color: white;
        border-radius: 4px;
    ...
    .submission-content .file-btn:hover {
        background-color: #218838; /* Added hover effect to match To-do List */
        border-color: #1e7e34;
        text-decoration: none;
    }
    ...
    .submission-content .file-btn i {
        color: white;
        margin-right: 5px;
        font-size: 0.875rem; /* Match the same size as the text */
    }
    ...
    * {
    ...
    /* Updated Submit button styling to match Todo List */
    .submit-btn {
        display: inline-block;
        padding: 8px 16px;
    ...
    /* Style the new container elements */
    ...
    /* Modal styling copied from Todo List */
    .modal-task-header {
        background-color: #007bff;
        color: white;
        border-bottom: none;
    ...
    /* Ensure modal backdrop is always removed */
    .modal-backdrop {
            ...
            <div class="tasks-container">
                ...
                <?php else: ?>
                    <?php foreach ($tasks as $task): 
                        // Define default values for status
