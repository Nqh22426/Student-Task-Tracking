...
if (!empty($class_ids)) {
    ...
    date_default_timezone_set('Asia/Ho_Chi_Minh'); // Make sure timezone is correct
    $now = new DateTime('now'); // Force a fresh datetime object
    $current_date = $now->format('Y-m-d H:i:s');
    
    // Debug - You can comment this out after fixing the issue
    error_log("Todo list checking for ongoing tasks at: " . $current_date);
    ...
    // Debug - You can comment this out after fixing the issue
    error_log("Found " . count($ongoing_tasks) . " ongoing tasks");
}
...
<head>
    ...
    <style>
        ...
        .task-list-item {
            ...
            margin-bottom: 15px;
            position: relative;
            min-height: 170px; /* Add minimum height to ensure container can fit submission box */
        ...
        .task-content {
            padding: 15px;
            position: relative; /* For proper positioning of floated elements */
        }
        ...
        .submission-container {
            ...
            overflow: hidden;
            font-size: 0.9rem;
            max-width: 100%; /* Ensure it doesn't extend beyond parent */
        }
        ...
        .submission-content {
            padding: 10px;
            position: relative;
            padding-bottom: 40px; /* Để có không gian cho nút Unsubmit */
        }
        ...
        /* Make sure the float-end container that holds the submission stays within bounds */
        .float-end {
            max-width: 280px; /* Match the width of submission container */
        ...
        /* Ensure floated elements stay within the container */
        .task-content:after {
            content: "";
            display: table;
            clear: both;
        ...
        @media (max-width: 767px) {
            .task-content {
                flex-direction: column-reverse; /* Show submission first on mobile */
            }
...
<body>
                                    ...
                                    <div class="float-end">
                                        <div class="d-flex flex-column align-items-end">
                                            ...
                                            <?php if (isset($submissions[$task['id']])): 
                                                ...
                                                // Tính toán đường dẫn file từ thông tin người dùng và tên file
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Handle task submit button click
