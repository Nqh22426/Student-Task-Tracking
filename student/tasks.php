                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <?php if ($current_class): ?>
                        <a href="tasks.php" class="btn btn-outline-secondary">
                            <i class="bi bi-arrow-left me-1"></i> Quay lại tất cả nhiệm vụ
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <div class="card filter-card">
                    <div class="card-body">
                        <form method="GET" action="tasks.php" class="row g-3">
                            ...
                            <div class="col-md-3">
                                <label for="filter" class="form-label">Trạng thái</label>
                                <select class="form-select" id="filter" name="filter">
                                    <option value="all" <?php echo $filter === 'all' ? 'selected' : ''; ?>>Tất cả trạng thái</option>
                                    <option value="not_started" <?php echo $filter === 'not_started' ? 'selected' : ''; ?>>Chưa bắt đầu</option>
                ...
                <?php if (empty($tasks)): ?>
                    <div class="empty-state">
                        ...
                        <p class="text-muted">
                            ...
                            <?php else: ?>
                                Bạn chưa có nhiệm vụ nào. Hãy tham gia các lớp học để nhận nhiệm vụ.
                            <?php endif; ?>
                        </p>
                        <?php if (!empty($search) || $filter !== 'all' || $class_id): ?>
