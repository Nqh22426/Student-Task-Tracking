...
<head>
    ...
    <style>
    /* Styling based on Tasks List page */
    .main-content {
        margin-left: 180px;
        padding: 20px;
        padding-top: 68px;
    ...
    /* Ensure the right column aligns items to end */
    ...
    /* Reduce vertical margin between grade and submission */
